...
public class ActivateIntegradoraCommandHandler(
    IRepository<Integradora> repo,
    IUnitOfWork uow,
    ICurrentUserService currentUser)
    : IRequestHandler<ActivateIntegradoraCommand, Result>
{
    public async Task<Result> Handle(ActivateIntegradoraCommand request, CancellationToken ct)
    {
