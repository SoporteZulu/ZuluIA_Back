...
internal class RegistrarDevolucionCompraInternaCommandValidator : AbstractValidator<RegistrarDevolucionCompraInternaCommand>
{
    public RegistrarDevolucionCompraInternaCommandValidator()
    {
