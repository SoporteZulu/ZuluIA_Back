...
public class RegistrarComprobantePuntoVentaCommandValidator : AbstractValidator<RegistrarComprobantePuntoVentaCommand>
{
    public RegistrarComprobantePuntoVentaCommandValidator()
    {
