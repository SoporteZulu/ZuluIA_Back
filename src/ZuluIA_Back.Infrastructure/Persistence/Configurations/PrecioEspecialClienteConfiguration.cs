...
public class PrecioEspecialClienteConfiguration : IEntityTypeConfiguration<PrecioEspecialCliente>
{
    public void Configure(EntityTypeBuilder<PrecioEspecialCliente> builder)
    {
        builder.ToTable("precios_especiales_clientes");
        ...
        builder.HasIndex(x => new { x.ItemId, x.ClienteId, x.MonedaId })
               .IsUnique()
