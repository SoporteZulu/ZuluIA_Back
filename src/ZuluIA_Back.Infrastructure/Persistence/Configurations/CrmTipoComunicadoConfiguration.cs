...
public class CrmTipoComunicadoConfiguration : IEntityTypeConfiguration<CrmTipoComunicado>
{
    public void Configure(EntityTypeBuilder<CrmTipoComunicado> builder)
    {
        builder.ToTable("CRMTIPOCOMUNICADOS");
