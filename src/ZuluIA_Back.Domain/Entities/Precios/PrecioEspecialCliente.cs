...
/// <summary>
/// Precio especial para un cliente específico.
/// Tiene la máxima prioridad en la resolución de precios.
/// </summary>
public class PrecioEspecialCliente : AuditableEntity
{
    ...
    private PrecioEspecialCliente() { }

    public static PrecioEspecialCliente Crear(
        long itemId,
        long clienteId,
        long monedaId,
        decimal precio,
        ...
        long? userId)
    {
        ...
        var precioEspecial = new PrecioEspecialCliente
        {
            ItemId         = itemId,
            ClienteId      = clienteId,
            MonedaId       = monedaId,
