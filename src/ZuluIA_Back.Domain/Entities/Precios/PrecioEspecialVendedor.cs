...
/// <summary>
/// Precio especial para un vendedor específico.
/// </summary>
public class PrecioEspecialVendedor : AuditableEntity
{
    ...
    private PrecioEspecialVendedor() { }

    public static PrecioEspecialVendedor Crear(
        long itemId,
        long vendedorId,
        long monedaId,
        decimal precio,
        ...
        long? userId)
    {
        ...
        var precioEspecial = new PrecioEspecialVendedor
        {
            ItemId         = itemId,
