...
{
    private readonly CerrarPeriodoContableCommandValidator _validator = new();

    [Fact]
    public void Validar_EjercicioInvalido_DebeTenerError()
    {
        var cmd = new CerrarPeriodoContableCommand(0, null, new DateOnly(2025, 1, 1), new DateOnly(2025, 1, 31), null);
